    ...
    <div className="space-y-6">
      ...
      {activeMenuId && (
        <>
          ...
          <div 
            className="fixed z-[110] w-44 rounded-lg bg-surface-container-lowest shadow-lg border border-outline-variant py-1 text-left"
            style={{ top: menuPos.top, right: menuPos.right }}
          >
            <Link
              href={`/bookings/${activeMenuId}`}
            ...
            <a
              href={`mailto:player@quickcourt.in?subject=QuickCourt%20Booking%20${activeMenuId}`}
              className="flex items-center gap-2 px-3.5 py-2 text-body-sm text-on-surface hover:bg-surface-container transition-colors"
              onClick={() => setActiveMenuId(null)}
            >
